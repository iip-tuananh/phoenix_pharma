...
<section class="page-about">
    <section class="core_values section_blog">
        <div class="container">
            <div class="title-blog" style="margin-bottom: 16px; margin-top: 20px; border-bottom: 1px solid #e1e1e1e1;">
                <h2 style="font-size: 26px; font-weight: 700;">
                    <a href="javascript:void(0)" title="{{ $blog_title }}">{{ $blog_title }}</a>
                </h2>
            </div>
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 32px;">
                    {!! $blog->body !!}
                </div>
            </div>
        </div>
