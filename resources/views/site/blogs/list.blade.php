...
<section class="page-about">
    <section class="core_values section_blog" style="padding-top: 0;">
        <div class="container">
            <div class="block-title" style="margin-bottom: 0;">
                <h2>
                    <a href="{{ route('front.list-blog', $cate_slug) }}" title="Chuyên mục: {{ $cate_title }}">Chuyên mục: {{ $cate_title }}</a>
                </h2>
            </div>
            <div class="block-blog row">
                @foreach ($blogs as $blog)
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6" style="margin-bottom: 32px;">
                    <div class="item-blog">
